...
/* FR-002: User Login. Email/password, OAuth, JWT, Remember Me. FR-003: Forgot password link. */
...
export default function SignInPage() {
  ...
  const handleEmailSignIn = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // TODO: POST /api/v1/auth/login — FR-002. Return JWT, refresh token.
      // await fetch('/api/v1/auth/login', { method: 'POST', body: JSON.stringify({ email, password }) });
  ...
  const handleGoogleSignIn = () => {
    // TODO: Google OAuth — FR-002
    router.push('/dashboard');
  };

  const handleGitHubSignIn = () => {
    // TODO: GitHub OAuth — FR-002
    router.push('/dashboard');
  };
