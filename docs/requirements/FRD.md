...
1. **Credits**: 10 credits per job
2. **Welcome Credits**: 100 credits for new users
3. **Script Length**: 50-5000 characters
4. **Film Duration**: 30, 60, or 90 seconds
5. **Content Moderation**: Automatic filtering + admin review
6. **Rate Limiting**: 10 job submissions per hour per user
7. **Job Retention**: Completed jobs stored for 30 days
8. **File Formats**: MP4 (H.264, 1080p)
